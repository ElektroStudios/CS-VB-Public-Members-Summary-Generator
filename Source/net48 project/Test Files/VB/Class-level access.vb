' This file contains a public class, a friend class and a class with no access modifier specified (public).
' Within these classes, there are members with all combinations of access modifiers.
'
' The generator should only generate summary for the public members of the public and no modifier (public) classes,
' while ignoring all members of the friend class.

#Disable Warning ' Disable all warnings in this file to test the generator.

#Region " TestClass Public "
...
#Region " Operators "
    ...
    Public Shared Widening Operator CType(instance As TestClassPublic) As String : End Operator

    Shared Operator -(a As TestClassPublic, b As TestClassPublic) As String : End Operator

    Shared Shadows Operator =(a As TestClassPublic, b As TestClassPublic) As String : End Operator

    Public Shared Shadows Operator <>(a As TestClassPublic, b As TestClassPublic) As String : End Operator

    Public Shared Operator +(a As TestClassPublic, b As TestClassPublic) As String : End Operator
...
#Region " Operators "
    ...
    Public Shared Widening Operator CType(instance As TestClassFriend) As String : End Operator

    Shared Operator -(a As TestClassFriend, b As TestClassFriend) As String : End Operator

    Shared Shadows Operator =(a As TestClassFriend, b As TestClassFriend) As String : End Operator

    Public Shared Shadows Operator <>(a As TestClassFriend, b As TestClassFriend) As String : End Operator

    Public Shared Operator +(a As TestClassFriend, b As TestClassFriend) As String : End Operator
...
#Region " Operators "
    ...
    Public Shared Widening Operator CType(instance As TestClassNoModifier) As String : End Operator

    Shared Operator -(a As TestClassNoModifier, b As TestClassNoModifier) As String : End Operator

    Shared Shadows Operator =(a As TestClassNoModifier, b As TestClassNoModifier) As String : End Operator

    Public Shared Shadows Operator <>(a As TestClassNoModifier, b As TestClassNoModifier) As String : End Operator

    Public Shared Operator +(a As TestClassNoModifier, b As TestClassNoModifier) As String : End Operator
